...
export function ModuleActions({
  ...
  async function move(direction: "up" | "down") {
    setBusy(true);
    await fetch("/api/admin/content/module", {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ id: moduleId, direction }),
    });
    setBusy(false);
    router.refresh();
  }
  ...
  async function remove() {
    if (!confirm("Delete this module and all of its items?")) return;
    setBusy(true);
    await fetch("/api/admin/content/module", {
      method: "DELETE",
      headers: { "Content-Type": "application/json" },
